...
function encodeParameter(parameter, writer) {
    ...
    if (parameter.enumMap != null) {
        ...
        (0, StringIntegerCollection_1.encodeStringIntegerCollection)(parameter.enumMap, writer);
        writer.endSequence();
    }
    if (parameter.streamDescriptor != null) {
        writer.startSequence(Ber.CONTEXT(16));
        (0, StreamDescription_1.encodeStreamDescription)(parameter.streamDescriptor, writer);
        writer.endSequence();
    }
